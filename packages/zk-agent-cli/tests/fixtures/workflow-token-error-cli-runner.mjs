...
const provider = {
  ...
  async getFundingInfo() {
    throw new Error('getFundingInfo should not run in workflow token-error test');
  }
};

const defiProvider = {
  async bridgeStatus() {
    throw new Error('bridgeStatus should not run in workflow token-error test');
  },
  async depositStatus() {
    throw new Error('depositStatus should not run in workflow token-error test');
  }
};
