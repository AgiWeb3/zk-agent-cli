...
function buildWorkflowHelpText(): string {
  return [
    ...
    '',
    '  Checkpoint lifecycle when you want explicit control:',
    ...
    '',
    '  Funding-only recovery when execution is blocked on gas:',
    '    zk-agent workflow fund --wallet main --amount <amount> --execute',
    '',
    '  Discovery / token recovery before the workflow can continue:',
    ...
    '    zk-agent defaults',
    '',
    '  When the question becomes broader than one explicit workflow:',
    '    zk-agent suite',
    '',
