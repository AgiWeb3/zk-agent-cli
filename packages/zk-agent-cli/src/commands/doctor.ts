...
function buildDoctorHelpText(): string {
  return [
    ...
    '  next   -> you are just beginning and still want live routing on the default path',
    '  doctor -> local state is unclear and you need diagnosis before choosing a fix',
    '  wallet -> the blocker is already clearly approval, signer, or session recovery',
    '  suite  -> diagnosis says readiness is clear and the question is broader than recovery',
    '',
