export interface KnownTransactionValidationFailure {
  kind: string;
...
export function classifyKnownTransactionValidationFailure(
  cause: string,
  options: { systemContextAddress?: string } = {}
): KnownTransactionValidationFailure | undefined {
