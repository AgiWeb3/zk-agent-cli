...
const exportsToWrite = [
  {
    compiledArtifactPath: path.join(
      ...
      'StandardTestToken.json'
    ),
    outputPath: path.join(packageRoot, 'artifacts', 'tokens', 'StandardTestToken.eravm.json'),
    contractName: 'StandardTestToken',
    sourceName: 'contracts/StandardTestToken.sol'
  },
  {
    compiledArtifactPath: path.join(
      packageRoot,
      ...
      'ManagedPaymaster.json'
    ),
    outputPath: path.join(packageRoot, 'artifacts', 'paymasters', 'ManagedPaymaster.json'),
    contractName: 'ManagedPaymaster',
    sourceName: 'contracts/ManagedPaymaster.sol'
  }
];
