...
- current prepared release candidate baseline for `2026-09-14`:
  `zk-agent-cli@0.1.0-rc.6`
- intended post-publish npm readback:
  - `npm view zk-agent-cli version -> 0.1.0-rc.6`
  - `npm view zk-agent-cli@latest version -> 0.1.0-rc.6`
  - `npm view zk-agent-cli@beta version -> 0.1.0-beta.11`
  - `npm view zk-agent-cli@rc version -> 0.1.0-rc.6`
  - `npm view zk-agent-cli dist-tags --json -> {"beta":"0.1.0-beta.11","rc":"0.1.0-rc.6","latest":"0.1.0-rc.6"}`
